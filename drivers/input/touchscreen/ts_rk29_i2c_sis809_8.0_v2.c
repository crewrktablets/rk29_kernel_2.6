...
//�Զ�У׼
static ssize_t tp_cal_show(struct kobject *kobj, struct kobj_attribute *attr,
...
static ssize_t tp_cal_store(struct kobject *kobj, struct kobj_attribute *attr,
			 const char *buf, size_t count)
{
...
static struct kobj_attribute tp_cal_attrs =
{
        .attr = {
                .name = "tp_calibration",
                .mode = 0777},
