...
static int rk29_lcd_io_init(void)
{
    ...
    if(ret != 0)
    {
        ...
        printk(">>>>>> LCD_CLK_PIN gpio_request err \n ");
        gpio_direction_output(LCD_CLK_PIN, GPIO_HIGH);
    ...
    if(ret != 0)
    {
        ...
        printk(">>>>>> LCD_TXD_PIN gpio_request err \n ");
        gpio_direction_output(LCD_TXD_PIN, GPIO_HIGH);
...
int sis809_init_platform_hw(void)
{
    if(gpio_request(TOUCH_RESET_PIN,NULL) != 0){
      gpio_free(TOUCH_RESET_PIN);
      printk("sis809_init_platform_hw gpio_request error\n");
      return -EIO;
    }
...
static struct sis809_platform_data sis809_info = {
  .model= 1003,
  .init_platform_hw = sis809_init_platform_hw,

};
#endif
#if defined (CONFIG_I2C_LZ300) || defined (CONFIG_I2C_LZ300_ST)
#define TOUCH_INT_PIN   RK29_PIN0_PA2
...
static struct i2c_board_info __initdata board_i2c2_devices[] = {
    ...
    {
      .type           = "sis809_touch",
      .addr           = 0x2e, /* 0x5c in dev */
      .flags          = 0,
      .irq            = RK29_PIN0_PA2,
      .platform_data  = &sis809_info,
    },
#endif
#if defined (CONFIG_I2C_LZ300) || defined (CONFIG_I2C_LZ300_ST)
    {
...
#define SENSOR_NAME_1 RK29_CAM_SENSOR_NAME_OV7675			/* front camera sensor */
