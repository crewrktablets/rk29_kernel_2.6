...
{    
    ...
    if(ddr_debug == 1)
    {
        ...
        for (;;)
        {
	        ...
	        printch(' ');
            printhex(readl(RK29_DDRC_BASE + 0xc));//CSR
	        printch(' ');
            printhex(readl(RK29_DDRC_BASE + 0x4c));//RSLR0
	        printch(' ');
            printhex(readl(RK29_DDRC_BASE + 0x50));//RSLR1
	        printch(' ');
            printhex(readl(RK29_DDRC_BASE + 0x5c));//RDGR0
	        printch(' ');
            printhex(readl(RK29_DDRC_BASE + 0x60));//RDGR1
