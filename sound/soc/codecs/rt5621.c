...
static struct rt5621_reg init_data[] = {
	...
	{RT5621_STEREO_DAC_VOL,         0x0707},    //default stereo DAC volume to 0db
	...
	{RT5621_MIC_CTRL,               0x0a00}, // 0x0500},    //set Mic1,Mic2 boost 20db	
...
{
       //printk("____zah +++codec_set_spk= %d\n",on);
	rt5621_AudioOutEnable(rt5621_socdev ->card->codec,RT_WAVOUT_SPK,!on);
	return;
}
